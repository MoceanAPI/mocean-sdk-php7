...
class TgSendVideoTest extends AbstractTesting
{
     ...
     * @expectedExceptionMessage missing expected key `to` from Mocean\Command\Mc\TgSendVideo
     */
    public function testRequiredField()
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage("missing expected key `to` from Mocean\Command\Mc\TgSendVideo");
